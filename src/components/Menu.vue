<template>
		...
		<header>
			<div class="wrap">
				...
				<img src="@/assets/VictoryMarketing.png" alt="logo">
				<nav id="menu">
					<li><a>회사소개</a></li>
					<li class="drop"><a v-on:click="display_drop_menu()">웹마케팅 <i class="icon-arrow"></i></a>
						<ul class="drop_menu">
							<a>Sub menu 1</a>
							<a>Sub menu 2</a>
							<a>Sub menu 3</a>
					...
					<li class="drop"><a v-on:click="display_drop_menu()">모바일광고  <i class="icon-arrow"></i></a>
						<ul class="drop_menu">
							<a>Sub menu 1</a>
							<a>Sub menu 2</a>
							<a>Sub menu 3</a>
		...
		<!-- <div id="background">
			...
			<button v-on:click="loaded()">Click here for loader!</button>
		</div> -->
	</div>
</template>
...
html, body {margin: 0;width: 100%;height: 100%; font-size: 17px; font-family: 'Roboto', sans-serif;}
